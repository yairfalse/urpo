...
fn draw_basic_info(frame: &mut Frame, area: Rect, span: &Span) {
    ...
    lines.push(Line::from(vec![
        ...
        TextSpan::styled(span.trace_id.as_str(), Style::default().fg(Color::Yellow)),
        TextSpan::styled(" [Y]", Style::default().fg(Color::DarkGray)),
    ]));
    ...
    if let Some(parent_id) = &span.parent_span_id {
        lines.push(Line::from(vec![
            ...
            TextSpan::styled(parent_id.as_str(), Style::default().fg(Color::DarkGray)),
        ]));
    }
    ...
    lines.push(Line::from(vec![
        ...
        TextSpan::styled(&span.operation_name, Style::default().fg(Color::Magenta)),
    ]));
    ...
    lines.push(Line::from(vec![
        ...
        TextSpan::styled(formatted_timestamp, Style::default().fg(Color::White)),
    ]));
    ...
    let items: Vec<ListItem> = attributes
        ...
        .map(|(key, value)| {
            let content = Line::from(vec![
                TextSpan::styled(format!("{}: ", key), Style::default().fg(Color::Yellow)),
...
fn draw_tags(frame: &mut Frame, area: Rect, span: &Span) {
    ...
    let items: Vec<ListItem> = tags
        ...
        .map(|(key, value)| {
            let content = Line::from(vec![
                TextSpan::styled(format!("{}=", key), Style::default().fg(Color::Magenta)),
                TextSpan::styled(value.clone(), Style::default().fg(Color::White)),
            ]);
            ListItem::new(content)
        })
...
fn draw_events(frame: &mut Frame, area: Rect, span: &Span) {
    ...
    if span.status.is_error() {
        lines.push(Line::from(vec![
            TextSpan::styled(
                format!("{}ms: ", span.duration.as_millis()),
